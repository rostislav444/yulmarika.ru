...
class Product(metaTags, ModelImages,):
    ...
    code =           models.CharField(unique=True, max_length=1000, verbose_name="Артикул")
    slug =           models.SlugField(max_length=1000, editable=False, null=True, blank=True)
    ...
    image =          models.FileField(max_length=1000, blank=True, null=True, upload_to='', verbose_name="Карточка товара (основная)")
    image_thmb =     JSONField(editable=True, null=True, blank=True, default=dict)
    add_image =      models.FileField(max_length=1000, blank=True, null=True, upload_to='', verbose_name="Карточка товара (дополнительная)")
...
class Variant(ModelImages):
    ...
    photo_1 =      models.FileField(max_length=1000, verbose_name="Фото 1")
    photo_1_thmb = JSONField(editable=False, null=True, blank=True, default=dict)
    photo_2 =      models.FileField(max_length=1000, verbose_name="Фото 2", null=True, blank=True)
    photo_2_thmb = JSONField(editable=False, null=True, blank=True, default=dict)
    photo_3 =      models.FileField(max_length=1000, verbose_name="Фото 3", null=True, blank=True)
    photo_3_thmb = JSONField(editable=False, null=True, blank=True, default=dict)
    photo_4 =      models.FileField(max_length=1000, verbose_name="Фото 4", null=True, blank=True)
